          ...
          child: SingleChildScrollView(
            child: DefaultTextStyle(
              ...
              child: Column(children: [
                ...
                Text('Se juega con una baraja española de 40 cartas (sin 8 ni 9), '
                ...
                Text('Se juega por turnos contra la banca o entre dos jugadores (el segundo '
                    'jugador actúa como la banca).\n'),
                Text('Primero un jugador va sacando carta del mazo de la baraja hasta que se '
